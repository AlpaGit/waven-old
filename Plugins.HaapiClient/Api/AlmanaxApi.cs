...
// Type: Com.Ankama.Haapi.Swagger.Api.AlmanaxApi
...
{
  public class AlmanaxApi : IAlmanaxApi
  {
    public AlmanaxApi(ApiClient apiClient = null)
    {
      if (apiClient == null)
    ...
    public AlmanaxApi(string basePath) => this.ApiClient = new ApiClient(basePath);
    ...
    public RAlmanaxApi<Almanax> GetEvent(string lang, string date)
    {
      if (lang == null)
        throw new ApiException(400, "Missing required parameter 'lang' when calling GetEvent");
      string path = "/Almanax/GetEvent".Replace("{format}", "json");
      ...
      Almanax data = (Almanax) this.ApiClient.Deserialize(restResponse.Content, typeof (Almanax), restResponse.Headers);
      return new RAlmanaxApi<Almanax>(restResponse, data);
    }
  }
}
