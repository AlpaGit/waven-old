...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredDofusHavenBagRoom
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsActionsDeliveredDofusHavenBagRoom
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredDofusHavenBagRoom {\n");
