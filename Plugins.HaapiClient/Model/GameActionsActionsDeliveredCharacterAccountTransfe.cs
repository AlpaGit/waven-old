...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredCharacterAccountTransfer
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsActionsDeliveredCharacterAccountTransfer
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredCharacterAccountTransfer {\n");
