...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsAccountWakfuCharacterRename
...
{
  [DataContract]
  public class GameActionsActionsAccountWakfuCharacterRename
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsAccountWakfuCharacterRename {\n");
