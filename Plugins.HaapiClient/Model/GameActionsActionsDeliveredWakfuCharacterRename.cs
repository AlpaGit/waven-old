...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredWakfuCharacterRename
...
{
  [DataContract]
  public class GameActionsActionsDeliveredWakfuCharacterRename
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredWakfuCharacterRename {\n");
