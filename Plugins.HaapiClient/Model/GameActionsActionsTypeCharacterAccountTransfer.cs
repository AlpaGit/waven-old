...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsTypeCharacterAccountTransfer
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsActionsTypeCharacterAccountTransfer
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsTypeCharacterAccountTransfer {\n");
