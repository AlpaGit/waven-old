...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsTypeDofusTouchItem
...
{
  [DataContract]
  public class GameActionsActionsTypeDofusTouchItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsTypeDofusTouchItem {\n");
