...
// Type: Com.Ankama.Haapi.Swagger.Model.OAuthAccount
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class OAuthAccount
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class OAuthAccount {\n");
      stringBuilder.Append("  ProviderId: ").Append((object) this.ProviderId).Append("\n");
