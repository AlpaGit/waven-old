...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredKrosmagaWheelToken
...
{
  [DataContract]
  public class GameActionsActionsDeliveredKrosmagaWheelToken
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredKrosmagaWheelToken {\n");
