...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsSimpleWakfuCharacterRename
...
{
  [DataContract]
  public class GameActionsActionsSimpleWakfuCharacterRename
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsSimpleWakfuCharacterRename {\n");
