...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsAccountAvailable
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsAccountAvailable
  {
    ...
    public List<GameActionsActionsAccountMeta> Actions { get; set; }
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsAccountAvailable {\n");
