...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredDofusPetsItem
...
{
  [DataContract]
  public class GameActionsActionsDeliveredDofusPetsItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredDofusPetsItem {\n");
