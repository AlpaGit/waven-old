...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsSimpleCharacterAccountTransfer
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsActionsSimpleCharacterAccountTransfer
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsSimpleCharacterAccountTransfer {\n");
