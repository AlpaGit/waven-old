...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsSimpleDofusTouchItem
...
{
  [DataContract]
  public class GameActionsActionsSimpleDofusTouchItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsSimpleDofusTouchItem {\n");
