...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsAccountKrosmagaCustomisation
...
{
  [DataContract]
  public class GameActionsActionsAccountKrosmagaCustomisation
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsAccountKrosmagaCustomisation {\n");
