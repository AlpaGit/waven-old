...
// Type: Com.Ankama.Haapi.Swagger.Model.CmsArticleExtended
...
{
  [DataContract]
  public class CmsArticleExtended
  {
    [DataMember(Name = "body", EmitDefaultValue = false)]
    [JsonProperty(PropertyName = "body")]
    public string Body { get; set; }

    [DataMember(Name = "previousArticleUrl", EmitDefaultValue = false)]
    [JsonProperty(PropertyName = "previousArticleUrl")]
    public string PreviousArticleUrl { get; set; }

    [DataMember(Name = "nextArticleUrl", EmitDefaultValue = false)]
    [JsonProperty(PropertyName = "nextArticleUrl")]
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class CmsArticleExtended {\n");
      stringBuilder.Append("  Body: ").Append(this.Body).Append("\n");
      stringBuilder.Append("  PreviousArticleUrl: ").Append(this.PreviousArticleUrl).Append("\n");
      stringBuilder.Append("  NextArticleUrl: ").Append(this.NextArticleUrl).Append("\n");
