...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsAccountDofusPetsItem
...
{
  [DataContract]
  public class GameActionsActionsAccountDofusPetsItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsAccountDofusPetsItem {\n");
