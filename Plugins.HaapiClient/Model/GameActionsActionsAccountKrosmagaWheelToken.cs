...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsAccountKrosmagaWheelToken
...
{
  [DataContract]
  public class GameActionsActionsAccountKrosmagaWheelToken
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsAccountKrosmagaWheelToken {\n");
