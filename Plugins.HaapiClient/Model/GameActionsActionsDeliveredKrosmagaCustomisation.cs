...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredKrosmagaCustomisation
...
{
  [DataContract]
  public class GameActionsActionsDeliveredKrosmagaCustomisation
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredKrosmagaCustomisation {\n");
