...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsSimpleDofusPetsItem
...
{
  [DataContract]
  public class GameActionsActionsSimpleDofusPetsItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsSimpleDofusPetsItem {\n");
