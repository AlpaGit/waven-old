...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredDofusTouchItem
...
{
  [DataContract]
  public class GameActionsActionsDeliveredDofusTouchItem
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredDofusTouchItem {\n");
