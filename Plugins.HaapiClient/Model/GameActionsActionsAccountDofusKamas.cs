...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsAccountDofusKamas
...
{
  [DataContract]
  public class GameActionsActionsAccountDofusKamas
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsAccountDofusKamas {\n");
