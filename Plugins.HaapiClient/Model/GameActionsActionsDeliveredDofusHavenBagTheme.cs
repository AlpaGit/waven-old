...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsDeliveredDofusHavenBagTheme
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class GameActionsActionsDeliveredDofusHavenBagTheme
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsDeliveredDofusHavenBagTheme {\n");
