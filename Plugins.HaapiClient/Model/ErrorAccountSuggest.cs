...
// Type: Com.Ankama.Haapi.Swagger.Model.ErrorAccountSuggest
...
namespace Com.Ankama.Haapi.Swagger.Model
{
  ...
  public class ErrorAccountSuggest
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class ErrorAccountSuggest {\n");
      stringBuilder.Append("  Suggests: ").Append((object) this.Suggests).Append("\n");
