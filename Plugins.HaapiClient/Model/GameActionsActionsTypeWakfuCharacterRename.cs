...
// Type: Com.Ankama.Haapi.Swagger.Model.GameActionsActionsTypeWakfuCharacterRename
...
{
  [DataContract]
  public class GameActionsActionsTypeWakfuCharacterRename
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.Append("class GameActionsActionsTypeWakfuCharacterRename {\n");
