...
// Type: Ankama.Cube.Data.StoppableCaracChangedEffectDefinition
...
namespace Ankama.Cube.Data
{
  ...
  public sealed class StoppableCaracChangedEffectDefinition : EffectExecutionWithDurationDefinition
  {
    ...
    public IStoppableCaracIdSelector caracSelector => this.m_caracSelector;
    ...
    public static StoppableCaracChangedEffectDefinition FromJsonToken(JToken token)
    {
      if (token.Type != JTokenType.Object)
      {
        Debug.LogWarning((object) ("Malformed token : type Object expected, but " + (object) token.Type + " found"));
        return (StoppableCaracChangedEffectDefinition) null;
      }
      JObject jsonObject = token.Value<JObject>();
      StoppableCaracChangedEffectDefinition effectDefinition = new StoppableCaracChangedEffectDefinition();
      effectDefinition.PopulateFromJson(jsonObject);
      return effectDefinition;
    }

    public static StoppableCaracChangedEffectDefinition FromJsonProperty(
      JObject jsonObject,
      string propertyName,
      StoppableCaracChangedEffectDefinition defaultValue = null)
    {
      JProperty jproperty = jsonObject.Property(propertyName);
      return jproperty == null || jproperty.Value.Type == JTokenType.Null ? defaultValue : StoppableCaracChangedEffectDefinition.FromJsonToken(jproperty.Value);
    }

    public override void PopulateFromJson(JObject jsonObject)
    {
      base.PopulateFromJson(jsonObject);
      this.m_caracSelector = IStoppableCaracIdSelectorUtils.FromJsonProperty(jsonObject, "caracSelector");
