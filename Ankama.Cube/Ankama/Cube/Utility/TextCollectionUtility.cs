...
// Type: Ankama.Cube.Utility.TextCollectionUtility
...
namespace Ankama.Cube.Utility
{
  public static class TextCollectionUtility
  {
    ...
    public static string GetFormattedText(CastValidity castValidity) => RuntimeData.FormattedText(string.Format("CastValidity.{0}", (object) castValidity), (IValueProvider) null);
    ...
    public struct BootKeys
    {
      ...
      public const int Erreur = 72461;
      public const int On = 86438;
      public const int Off = 33654;
      public const int NoScreenDevices = 28972;
      public const int NoScreenRatios = 48663;
      public const int NoScreenResolutions = 33868;
      public const int ScreenOptionInitFail = 10321;
      public const int ScreenOptionDesynchro = 97607;
    ...
    public struct InitializationFailureKeys
    {
      ...
      {
        int textKey = TextCollectionUtility.InitializationFailureKeys.GetTextKey(failure);
        return textKey == 0 ? string.Format("InitializationFailure: {0}", (object) failure) : RuntimeData.FormattedText(textKey, (IValueProvider) null);
      }
      ...
      private static int GetTextKey(Main.InitializationFailure failure)
      {
        switch (failure)
        {
          ...
          case Main.InitializationFailure.AssetManagerInitialisation:
            return 9761;
          default:
            Log.Warning(string.Format("Reason '{0}' not handled", (object) failure), 109, "C:\\BuildAgents\\AgentA\\work\\cub_client_win64_master\\client\\DofusCube.Unity\\Assets\\Core\\Code\\Utility\\TextCollectionUtility.cs");
            return 0;
        }
      }
    }
    ...
    public struct AuthenticationErrorKeys
    {
      ...
      {
        int textKey = TextCollectionUtility.AuthenticationErrorKeys.GetTextKey(error);
        return textKey == 0 ? string.Format("SpinError: {0}", (object) error) : RuntimeData.FormattedText(textKey, (IValueProvider) null);
      }
      ...
      private static int GetTextKey(SpinProtocol.ConnectionErrors error)
      {
        switch (error)
        {
          ...
          case SpinProtocol.ConnectionErrors.ServerError:
            return 89386;
          default:
            Log.Warning(string.Format("Error '{0}' not handled", (object) error), 147, "C:\\BuildAgents\\AgentA\\work\\cub_client_win64_master\\client\\DofusCube.Unity\\Assets\\Core\\Code\\Utility\\TextCollectionUtility.cs");
            return 0;
        }
      }
    }
    ...
    public struct DisconnectionReasonKeys
    {
      ...
      {
        int textKey = TextCollectionUtility.DisconnectionReasonKeys.GetTextKey(reason);
        return textKey == 0 ? string.Format("DisconnectionReason: {0}", (object) reason) : RuntimeData.FormattedText(textKey, (IValueProvider) null);
      }
      ...
      private static int GetTextKey(DisconnectedByServerEvent.Types.Reason reason)
      {
        switch (reason)
        {
          ...
          case DisconnectedByServerEvent.Types.Reason.LoggedInAgainWithSameAccount:
            return 18083;
          default:
            Log.Warning(string.Format("Reason '{0}' not handled", (object) reason), 178, "C:\\BuildAgents\\AgentA\\work\\cub_client_win64_master\\client\\DofusCube.Unity\\Assets\\Core\\Code\\Utility\\TextCollectionUtility.cs");
            return 0;
        }
      }
    }
