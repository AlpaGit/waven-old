...
// Type: Ankama.Cube.UI.Debug.FightAdminCommands.HealCommand
...
namespace Ankama.Cube.UI.Debug.FightAdminCommands
{
  public class HealCommand : ContinuousFightAdminCommand
  {
    ...
    protected override void Start()
    {
      ...
      fightMap.onTargetSelected = fightMap.onTargetSelected + new Action<Target?>(HealCommand.OnUpdateTarget);
    }
