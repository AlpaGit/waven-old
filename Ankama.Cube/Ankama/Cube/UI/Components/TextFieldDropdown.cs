...
// Type: Ankama.Cube.UI.Components.TextFieldDropdown
...
namespace Ankama.Cube.UI.Components
{
  ...
  public class TextFieldDropdown : 
    Selectable,
    ...
    ICancelHandler
  {
    ...
    private List<TextFieldDropdown.DropdownItem> m_Items = new List<TextFieldDropdown.DropdownItem>();
    ...
    {
      Dropdown.OptionData optionData = TextFieldDropdown.s_NoOptionData;
      ...
      if ((bool) (Object) this.m_CaptionText)
      {
        if (optionData != null && optionData.text != null)
          this.m_CaptionText.SetText(optionData.text);
        else
          this.m_CaptionText.SetText("");
      }
      if (!(bool) (Object) this.m_CaptionImage)
        return;
    ...
    private void SetupTemplate()
    {
      ...
      else
      {
        ...
        {
          TextFieldDropdown.DropdownItem dropdownItem = componentInChildren.gameObject.AddComponent<TextFieldDropdown.DropdownItem>();
    ...
    public void Show()
    {
      ...
      TextFieldDropdown.DropdownItem componentInChildren = this.m_Dropdown.GetComponentInChildren<TextFieldDropdown.DropdownItem>();
      ...
      {
        TextFieldDropdown.DropdownItem item = this.AddItem(this.options[index], this.value == index, componentInChildren, this.m_Items);
    ...
    protected virtual TextFieldDropdown.DropdownItem CreateItem(
      TextFieldDropdown.DropdownItem itemTemplate)
    {
      return Object.Instantiate<TextFieldDropdown.DropdownItem>(itemTemplate);
    }

    private TextFieldDropdown.DropdownItem AddItem(
      Dropdown.OptionData data,
      bool selected,
      TextFieldDropdown.DropdownItem itemTemplate,
      List<TextFieldDropdown.DropdownItem> items)
    {
      TextFieldDropdown.DropdownItem dropdownItem = this.CreateItem(itemTemplate);
      ...
      if ((bool) (Object) dropdownItem.text)
        dropdownItem.text.SetText(data.text);
