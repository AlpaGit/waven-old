...
// Type: Ankama.Cube.Protocols.PlayerProtocol.SelectDeckAndWeaponResultEvent
...
{
  public sealed class SelectDeckAndWeaponResultEvent : 
    IMessage<SelectDeckAndWeaponResultEvent>,
    IMessage,
    IEquatable<SelectDeckAndWeaponResultEvent>,
    IDeepCloneable<SelectDeckAndWeaponResultEvent>,
    ICustomDiagnosticMessage
  {
    ...
    [DebuggerNonUserCode]
    public static MessageParser<SelectDeckAndWeaponResultEvent> Parser => SelectDeckAndWeaponResultEvent._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => PlayerProtocolReflection.Descriptor.MessageTypes[13];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.pb\u003A\u003AGoogle\u002EProtobuf\u002EIMessage\u002EDescriptor => SelectDeckAndWeaponResultEvent.Descriptor;
    ...
    [DebuggerNonUserCode]
    public SelectDeckAndWeaponResultEvent Clone() => new SelectDeckAndWeaponResultEvent(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as SelectDeckAndWeaponResultEvent);
    ...
    public string ToDiagnosticString() => nameof (SelectDeckAndWeaponResultEvent);
  }
}
