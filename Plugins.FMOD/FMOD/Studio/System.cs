...
namespace FMOD.Studio
{
  ...
  public struct System
  {
    ...
    public static RESULT create(out FMOD.Studio.System studiosystem) => FMOD.Studio.System.FMOD_Studio_System_Create(out studiosystem.handle, 69648U);
    ...
    public RESULT loadBankMemoryPoint(byte[] buffer, LOAD_BANK_FLAGS flags, out Bank bank)
    {
      GCHandle gcHandle = GCHandle.Alloc((object) buffer, GCHandleType.Pinned);
      int num1 = (int) FMOD.Studio.System.FMOD_Studio_System_LoadBankMemory(this.handle, gcHandle.AddrOfPinnedObject(), buffer.Length, LOAD_MEMORY_MODE.LOAD_MEMORY_POINT, flags, out bank.handle);
      int num2 = (int) bank.setUserData(GCHandle.ToIntPtr(gcHandle));
      return (RESULT) num1;
    }
