...
namespace FMOD
{
  public struct Channel : IChannelControl
  {
    ...
    public RESULT setMixMatrix(float[] matrix, int outchannels, int inchannels, int inchannel_hop) => Channel.FMOD5_Channel_SetMixMatrix(this.handle, matrix, outchannels, inchannels, inchannel_hop);
    ...
    public RESULT getDelay(out ulong dspclock_start, out ulong dspclock_end, out bool stopchannels) => Channel.FMOD5_Channel_GetDelay(this.handle, out dspclock_start, out dspclock_end, out stopchannels);
    ...
    public RESULT getFadePoints(ref uint numpoints, ulong[] point_dspclock, float[] point_volume) => Channel.FMOD5_Channel_GetFadePoints(this.handle, ref numpoints, point_dspclock, point_volume);
    ...
    public RESULT get3DDistanceFilter(out bool custom, out float customLevel, out float centerFreq) => Channel.FMOD5_Channel_Get3DDistanceFilter(this.handle, out custom, out customLevel, out centerFreq);
