...
namespace FMOD
{
  public struct System
  {
    ...
    public RESULT setSoftwareFormat(int samplerate, SPEAKERMODE speakermode, int numrawspeakers) => FMOD.System.FMOD5_System_SetSoftwareFormat(this.handle, samplerate, speakermode, numrawspeakers);
    ...
    public RESULT getSpeakerPosition(SPEAKER speaker, out float x, out float y, out bool active) => FMOD.System.FMOD5_System_GetSpeakerPosition(this.handle, speaker, out x, out y, out active);
    ...
    public RESULT getStreamBufferSize(out uint filebuffersize, out TIMEUNIT filebuffersizetype) => FMOD.System.FMOD5_System_GetStreamBufferSize(this.handle, out filebuffersize, out filebuffersizetype);
    ...
    public RESULT createSound(string name, MODE mode, out Sound sound)
    {
      ...
      exinfo.cbsize = Marshal.SizeOf<CREATESOUNDEXINFO>(exinfo);
    ...
    public RESULT playDSP(DSP dsp, ChannelGroup channelGroup, bool paused, out Channel channel) => FMOD.System.FMOD5_System_PlayDSP(this.handle, dsp.handle, channelGroup.handle, paused, out channel.handle);
